% hsa-dev-rocm(SECTION) | User Commands
%
% "December 23 2024"
...
hsa-dev-rocm - program to do something

# SYNOPSIS

**hsa-dev-rocm** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**hsa-dev-rocm** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **hsa-dev-rocm** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**hsa-dev-rocm** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    hsa-dev-rocm. See **foo.conf**(5) for further details.
...
**hsa-dev-rocm** provides some return codes, that can be used in scripts:
...
CHEN Xuan <chenxuan@iscas.ac.cn>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 CHEN Xuan
